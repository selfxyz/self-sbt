...
/// @notice A Soulbound Token (SBT) template for Opera integration with Self Protocol identity verification
...
contract OperaSelfSBT is SelfVerificationRoot, ERC5192, Ownable {
    /*//////////////////////////////////////////////////////////////
                             STATE VARIABLES
    //////////////////////////////////////////////////////////////*/
    ...
    /// @param receiver The address that received the SBT
    ...
    /*//////////////////////////////////////////////////////////////
                              CONSTRUCTOR
    //////////////////////////////////////////////////////////////*/
    /// @notice Constructs the OperaSelfSBT contract
    ...
    constructor(
        ...
        ERC5192("OperaSelfSBT", "OPERASELF", true)
        Ownable(_owner)
    {
    ...
    /// @notice Custom verification hook for Opera SBT minting and renewal
    /// @param genericDiscloseOutput The generic disclose output from the hub
    /// @param - The user context data (unused in this implementation)
        ...
        override
    {
        ...
        if (!nullifierIsUsed && !receiverHasSBT) {
            ...
            // Case 2: Nullifier NEW + Receiver HAS SBT
            // New passport/account but address already holds an SBT.
            // User must burn existing token first, then re-verify to mint a new one.
        ...
        emit VerificationCompleted(receiver, nullifier, block.timestamp);
    }
